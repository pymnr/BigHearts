    ...
    v.flexslider = function(p, e) {
        ...
        v.data(p, "flexslider", m), u = {
            init: function() {
                ...
                }), m.vars.pauseInvisible && u.pauseInvisible.isHidden() || (0 < m.vars.initDelay ? m.startTimeout = setTimeout(m.play, m.vars.initDelay) : m.play())), d && u.asNav.setup(), o && m.vars.touch && u.touch(), (!x || x && m.vars.smoothHeight) && v(window).on("resize orientationchange focus", u.resize), m.find("img").attr("draggable", "false"), setTimeout(function() {
                    m.vars.start(m)
                }, 200)
            },
            asNav: {
                setup: function() {
                    m.asNav = !0, m.animatingTo = Math.floor(m.currentSlide / m.move), m.currentItem = m.currentSlide, m.slides.removeClass(s + "active-slide").eq(m.currentItem).addClass(s + "active-slide"), f ? (p._slider = m).slides.each(function() {
                        var e = this;
                        ...
                        e <= 0 && t.hasClass(s + "active-slide") ? m.flexAnimate(m.getTarget("prev"), !0) : v(m.vars.asNavFor).data("flexslider").animating || t.hasClass(s + "active-slide") || (m.direction = m.currentItem < a ? "next" : "prev", m.flexAnimate(a, m.vars.pauseOnAction, !1, !0, !0))
                    })
                }
            },
            controlNav: {
                ...
                setupPaging: function() {
                    var e, t = "thumbnails" === m.vars.controlNav ? "control-thumbs" : "control-paging",
                        a = 1;
                    if (m.controlNavScaffold = v('<ol class="' + s + "control-nav " + s + t + '"></ol>'), 1 < m.pagingCount)
                        for (var n = 0; n < m.pagingCount; n++) {
                            var i = m.slides.eq(n);
                            undefined === i.attr("data-thumb-alt") && i.attr("data-thumb-alt", ""), e = v("<a></a>").attr("href", "#").text(a), "thumbnails" === m.vars.controlNav && (e = v("<img/>").attr("src", i.attr("data-thumb"))), "" !== i.attr("data-thumb-alt") && e.attr("alt", i.attr("data-thumb-alt")), "thumbnails" !== m.vars.controlNav || !0 !== m.vars.thumbCaptions || "" !== (i = i.attr("data-thumbcaption")) && undefined !== i && (r = v("<span></span>").addClass(s + "caption").text(i), e.append(r));
                            var r = v("<li>");
                            e.appendTo(r), r.append("</li>"), m.controlNavScaffold.append(r), a++
                            ...
                            var t, a;
                            e.preventDefault(), "" !== c && c !== e.type || (t = v(this), a = m.controlNav.index(t), t.hasClass(s + "active") || (m.direction = a > m.currentSlide ? "next" : "prev", m.flexAnimate(a, m.vars.pauseOnAction))), "" === c && (c = e.type), u.setToClearWatchedEvent()
                        })
                },
                setupManual: function() {
                    m.controlNav = m.manualControls, u.controlNav.active(), m.controlNav.on(l, function(e) {
                        var t, a;
                        e.preventDefault(), "" !== c && c !== e.type || (t = v(this), a = m.controlNav.index(t), t.hasClass(s + "active") || (a > m.currentSlide ? m.direction = "next" : m.direction = "prev", m.flexAnimate(a, m.vars.pauseOnAction))), "" === c && (c = e.type), u.setToClearWatchedEvent()
                    })
                },
                set: function() {
                    var e = "thumbnails" === m.vars.controlNav ? "img" : "a";
                    m.controlNav = v("." + s + "control-nav li " + e, m.controlsContainer ? m.controlsContainer : m)
                },
                active: function() {
                    m.controlNav.removeClass(s + "active").eq(m.animatingTo).addClass(s + "active")
                },
                update: function(e, t) {
            ...
            directionNav: {
                setup: function() {
                    var e = v('<ul class="' + s + 'direction-nav"><li class="' + s + 'nav-prev"><a class="' + s + 'prev" href="#">' + m.vars.prevText + '</a></li><li class="' + s + 'nav-next"><a class="' + s + 'next" href="#">' + m.vars.nextText + "</a></li></ul>");
                    m.customDirectionNav ? m.directionNav = m.customDirectionNav : m.controlsContainer ? (v(m.controlsContainer).append(e), m.directionNav = v("." + s + "direction-nav li a", m.controlsContainer)) : (m.append(e), m.directionNav = v("." + s + "direction-nav li a", m)), u.directionNav.update(), m.directionNav.on(l, function(e) {
                        var t;
                        e.preventDefault(), "" !== c && c !== e.type || (t = v(this).hasClass(s + "next") ? m.getTarget("next") : m.getTarget("prev"), m.flexAnimate(t, m.vars.pauseOnAction)), "" === c && (c = e.type), u.setToClearWatchedEvent()
                    })
                },
                update: function() {
                    console.log("updating...");
                    var e = s + "disabled";
                    1 === m.pagingCount ? m.directionNav.addClass(e).attr("tabindex", "-1") : m.vars.animationLoop ? m.directionNav.removeClass(e).prop("tabindex", "-1") : 0 === m.animatingTo ? m.directionNav.removeClass(e).filter("." + s + "prev").addClass(e).attr("tabindex", "-1") : m.animatingTo === m.last ? m.directionNav.removeClass(e).filter("." + s + "next").addClass(e).attr("tabindex", "-1") : m.directionNav.removeClass(e).prop("tabindex", "-1")
                }
            },
            pausePlay: {
                setup: function() {
                    var e = v('<div class="' + s + 'pauseplay"><a href="#"></a></div>');
                    m.controlsContainer ? (m.controlsContainer.append(e), m.pausePlay = v("." + s + "pauseplay a", m.controlsContainer)) : (m.append(e), m.pausePlay = v("." + s + "pauseplay a", m)), u.pausePlay.update(m.vars.slideshow ? s + "pause" : s + "play"), m.pausePlay.on(l, function(e) {
                        e.preventDefault(), "" !== c && c !== e.type || (v(this).hasClass(s + "pause") ? (m.manualPause = !0, m.manualPlay = !1, m.pause()) : (m.manualPause = !1, m.manualPlay = !0, m.play())), "" === c && (c = e.type), u.setToClearWatchedEvent()
                    })
                },
                update: function(e) {
                    "play" === e ? m.pausePlay.removeClass(s + "pause").addClass(s + "play").html(m.vars.playText) : m.pausePlay.removeClass(s + "play").addClass(s + "pause").html(m.vars.pauseText)
                }
            },
            touch: function() {
                var n, i, r, s, o, l, e, c, d, u = !1,
                    t = 0,
                    a = 0,
                    v = 0;
                f ? (p.style.msTouchAction = "none", p._gesture = new MSGesture, (p._gesture.target = p).addEventListener("MSPointerDown", function(e) {
                    e.stopPropagation(), m.animating ? e.preventDefault() : (m.pause(), p._gesture.addPointer(e.pointerId), v = 0, s = g ? m.h : m.w, l = Number(new Date), r = S && h && m.animatingTo === m.last ? 0 : S && h ? m.limit - (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo : S && m.currentSlide === m.last ? m.limit : S ? (m.itemW + m.vars.itemMargin) * m.move * m.currentSlide : h ? (m.last - m.currentSlide + m.cloneOffset) * s : (m.currentSlide + m.cloneOffset) * s)
                    ...
                    var a = -e.translationX,
                        n = -e.translationY;
                    if (v += g ? n : a, o = (t.vars.rtl ? -1 : 1) * v, u = g ? Math.abs(v) < Math.abs(-a) : Math.abs(v) < Math.abs(-n), e.detail === e.MSGESTURE_FLAG_INERTIA) return void setImmediate(function() {
                        p._gesture.stop()
                    });
                    (!u || 500 < Number(new Date) - l) && (e.preventDefault(), !x && t.transitions && (t.vars.animationLoop || (o = v / (0 === t.currentSlide && v < 0 || t.currentSlide === t.last && 0 < v ? Math.abs(v) / s + 2 : 1)), t.setProps(r + o, "setTouch")))
                }, !1), p.addEventListener("MSGestureEnd", function(e) {
                    e.stopPropagation();
                    var t = e.target._slider;
                    if (!t) return; {
                        var a;
                        t.animatingTo !== t.currentSlide || u || null === o || (e = 0 < (a = h ? -o : o) ? t.getTarget("next") : t.getTarget("prev"), t.canAdvance(e) && (Number(new Date) - l < 550 && 50 < Math.abs(a) || Math.abs(a) > s / 2) ? t.flexAnimate(e, t.vars.pauseOnAction) : x || t.flexAnimate(t.currentSlide, t.vars.pauseOnAction, !0))
                    }
                    r = o = i = n = null, v = 0
                }, !1)) : (e = function(e) {
                    m.animating ? e.preventDefault() : !window.navigator.msPointerEnabled && 1 !== e.touches.length || (m.pause(), s = g ? m.h : m.w, l = Number(new Date), t = e.touches[0].pageX, a = e.touches[0].pageY, r = S && h && m.animatingTo === m.last ? 0 : S && h ? m.limit - (m.itemW + m.vars.itemMargin) * m.move * m.animatingTo : S && m.currentSlide === m.last ? m.limit : S ? (m.itemW + m.vars.itemMargin) * m.move * m.currentSlide : h ? (m.last - m.currentSlide + m.cloneOffset) * s : (m.currentSlide + m.cloneOffset) * s, n = g ? a : t, i = g ? t : a, p.addEventListener("touchmove", c, !1), p.addEventListener("touchend", d, !1))
                }, c = function(e) {
                    t = e.touches[0].pageX, a = e.touches[0].pageY, o = g ? n - a : (m.vars.rtl ? -1 : 1) * (n - t);
                    (!(u = g ? Math.abs(o) < Math.abs(t - i) : Math.abs(o) < Math.abs(a - i)) || 500 < Number(new Date) - l) && (e.preventDefault(), !x && m.transitions && (m.vars.animationLoop || (o /= 0 === m.currentSlide && o < 0 || m.currentSlide === m.last && 0 < o ? Math.abs(o) / s + 2 : 1), m.setProps(r + o, "setTouch")))
                }, d = function(e) {
                    var t, a;
                    p.removeEventListener("touchmove", c, !1), m.animatingTo !== m.currentSlide || u || null === o || (a = 0 < (t = h ? -o : o) ? m.getTarget("next") : m.getTarget("prev"), m.canAdvance(a) && (Number(new Date) - l < 550 && 50 < Math.abs(t) || Math.abs(t) > s / 2) ? m.flexAnimate(a, m.vars.pauseOnAction) : x || m.flexAnimate(m.currentSlide, m.vars.pauseOnAction, !0)), p.removeEventListener("touchend", d, !1), r = o = i = n = null
            ...
            if (m.vars.animationLoop || e === m.currentSlide || (m.direction = e > m.currentSlide ? "next" : "prev"), d && 1 === m.pagingCount && (m.direction = m.currentItem < e ? "next" : "prev"), !m.animating && (m.canAdvance(e, i) || a) && m.is(":visible")) {
                if (d && n) {
                    ...
                    if (m.atEnd = 0 === e || e === m.count - 1, n.flexAnimate(e, !0, !1, !0, i), m.direction = m.currentItem < e ? "next" : "prev", n.direction = m.direction, Math.ceil((e + 1) / m.visible) - 1 === m.currentSlide || 0 === e) return m.currentItem = e, m.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), !1;
                    m.currentItem = e, m.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), e = Math.floor(e / m.visible)
                }
                var r;
                m.animating = !0, m.animatingTo = e, t && m.pause(), m.vars.before(m), m.syncExists && !i && u.sync("animate"), m.vars.controlNav && u.controlNav.active(), S || m.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), m.atEnd = 0 === e || e === m.last, m.vars.directionNav && u.directionNav.update(), e === m.last && (m.vars.end(m), m.vars.animationLoop || m.pause()), x ? o ? (m.slides.eq(m.currentSlide).css({
                    opacity: 0,
                    zIndex: 1
                }), m.slides.eq(e).css({
                    opacity: 1,
                    zIndex: 2
                }), m.wrapup(r)) : (m.slides.eq(m.currentSlide).css({
                    zIndex: 1
                }).animate({
                    opacity: 0
                    ...
                    opacity: 1
                }, m.vars.animationSpeed, m.vars.easing, m.wrapup)) : (r = g ? m.slides.filter(":first").height() : m.computedW, e = S ? (i = m.vars.itemMargin, (i = (m.itemW + i) * m.move * m.animatingTo) > m.limit && 1 !== m.visible ? m.limit : i) : 0 === m.currentSlide && e === m.count - 1 && m.vars.animationLoop && "next" !== m.direction ? h ? (m.count + m.cloneOffset) * r : 0 : m.currentSlide === m.last && 0 === e && m.vars.animationLoop && "prev" !== m.direction ? h ? 0 : (m.count + 1) * r : h ? (m.count - 1 - e + m.cloneOffset) * r : (e + m.cloneOffset) * r, m.setProps(e, "", m.vars.animationSpeed), m.transitions ? (m.vars.animationLoop && m.atEnd || (m.animating = !1, m.currentSlide = m.animatingTo), m.container.off("webkitTransitionEnd transitionend"), m.container.on("webkitTransitionEnd transitionend", function() {
            ...
            x ? (m.vars.rtl ? m.slides.css({
                ...
                opacity: 1
            }, m.vars.animationSpeed, m.vars.easing)), m.vars.smoothHeight && u.smoothHeight()) : ("init" === e && (m.viewport = v('<div class="' + s + 'viewport"></div>').css({
                overflow: "hidden",
                position: "relative"
            ...
            }, "init" === e ? 100 : 0))), S || m.slides.removeClass(s + "active-slide").eq(m.currentSlide).addClass(s + "active-slide"), m.vars.init(m)
        }, m.doMath = function() {
        ...
        if (a === undefined && (a = {}), "object" == typeof a) return this.each(function() {
            var e = v(this),
