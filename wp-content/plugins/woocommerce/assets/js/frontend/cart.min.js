jQuery(function(n) {
    ...
    var r = function(t) {
        ...
        o = function(t, e) {
            var o, c, i = n.parseHTML(t),
                r = n(".woocommerce-cart-form", i),
                a = n(".cart_totals", i),
                t = (t = n(".woocommerce-error, .woocommerce-message, .woocommerce-info", i), o = [], (c = t).each(function(t) {
                    var e = n(this).text();
            ...
            if (0 !== n(".woocommerce-cart-form").length) {
                if (e || n(".woocommerce-error, .woocommerce-message, .woocommerce-info").remove(), 0 === r.length) {
                    ...
                    n(".woocommerce-cart-form__contents").closest(".woocommerce").replaceWith(i), 0 < t.length && u(t), n(document.body).trigger("wc_cart_emptied")
                } else n(".woocommerce-checkout").length && n(document.body).trigger("update_checkout"), n(".woocommerce-cart-form").replaceWith(r), n(".woocommerce-cart-form").find(':input[name="update_cart"]').prop("disabled", !0).attr("aria-disabled", !0), 0 < t.length && u(t), p(a);
        ...
        t = {
            ...
            input_changed: function() {
                n('.woocommerce-cart-form :input[name="update_cart"]').prop("disabled", !1).attr("aria-disabled", !1)
            },
            ...
            item_remove_clicked: function(t) {
                ...
                var t = n(t.currentTarget),
                    e = t.parents("form");
                a(e), a(n("div.cart_totals")), n.ajax({
                    type: "GET",
                    url: t.attr("href"),
                    dataType: "html",
                    success: function(t) {
                    ...
                    complete: function() {
                        s(e), s(n("div.cart_totals")), n.scroll_to_notices(n('[role="alert"]'))
                    }
                })
            },
