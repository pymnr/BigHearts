    ...
    var r = 0,
        ...
        c = function() {
            ...
            return a(i, [{
                ...
                value: function(l) {
                    var u = this;
                    u.$video ? l(u.$video) : u.onAPIready(function() {
                        var e = void 0;
                        if (u.$video || ((e = document.createElement("div")).style.display = "none"), "youtube" === u.type) {
                            u.playerOptions = {}, u.playerOptions.videoId = u.videoID, u.playerOptions.playerVars = {
                                ...
                                autoplay: 0,
                                playsinline: 1
                            }, u.options.showContols || (u.playerOptions.playerVars.iv_load_policy = 3, u.playerOptions.playerVars.modestbranding = 1, u.playerOptions.playerVars.controls = 0, u.playerOptions.playerVars.showinfo = 0, u.playerOptions.playerVars.disablekb = 1);
                            var t = void 0,
                                o = void 0;
                            u.playerOptions.events = {
                                onReady: function(t) {
                                    u.options.mute ? t.target.mute() : u.options.volume && t.target.setVolume(u.options.volume), u.options.autoplay && u.play(u.options.startTime), u.fire("ready", t), setInterval(function() {
                                ...
                                onStateChange: function(e) {
                                    u.options.loop && e.data === YT.PlayerState.ENDED && u.play(u.options.startTime), t || e.data !== YT.PlayerState.PLAYING || (t = 1, u.fire("started", e)), e.data === YT.PlayerState.PLAYING && u.fire("play", e), e.data === YT.PlayerState.PAUSED && u.fire("pause", e), e.data === YT.PlayerState.ENDED && u.fire("ended", e), e.data === YT.PlayerState.PLAYING ? o = setInterval(function() {
                            ...
                            if (i) {
                                ...
                                n.setAttribute("id", u.playerID), e.appendChild(n), document.body.appendChild(e)
                            }
                            u.player = u.player || new window.YT.Player(u.playerID, u.playerOptions), i && (u.$video = document.getElementById(u.playerID), u.videoWidth = parseInt(u.$video.getAttribute("width"), 10) || 1280, u.videoHeight = parseInt(u.$video.getAttribute("height"), 10) || 720)
                        }
                        if ("vimeo" === u.type) {
                            u.playerOptions = "", u.playerOptions += "player_id=" + u.playerID, u.playerOptions += "&autopause=0", u.playerOptions += "&transparent=0", u.options.showContols || (u.playerOptions += "&badge=0&byline=0&portrait=0&title=0"), u.playerOptions += "&autoplay=" + (u.options.autoplay ? "1" : "0"), u.playerOptions += "&loop=" + (u.options.loop ? 1 : 0), u.$video || (u.$video = document.createElement("iframe"), u.$video.setAttribute("id", u.playerID), u.$video.setAttribute("src", "https://player.vimeo.com/video/" + u.videoID + "?" + u.playerOptions), u.$video.setAttribute("frameborder", "0"), e.appendChild(u.$video), document.body.appendChild(e)), u.player = u.player || new Vimeo.Player(u.$video), u.player.getVideoWidth().then(function(e) {
                                u.videoWidth = e || 1280
                            }), u.player.getVideoHeight().then(function(e) {
                                u.videoHeight = e || 720
                            }), u.options.startTime && u.options.autoplay && u.player.setCurrentTime(u.options.startTime), u.options.mute ? u.player.setVolume(0) : u.options.volume && u.player.setVolume(u.options.volume);
                            var a = void 0;
                            u.player.on("timeupdate", function(e) {
                                a || (u.fire("started", e), a = 1), u.fire("timeupdate", e), u.options.endTime && u.options.endTime && e.seconds >= u.options.endTime && (u.options.loop ? u.play(u.options.startTime) : u.pause())
